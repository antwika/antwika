...
namespace
{
    ...
    // Pumps until as many packets as asked for have turned up.
...
// Port 0 asks the operating system to choose -- see IHost::endpoint().
...
// The whole point of the length prefix.
// A stream has no message boundaries of its own.
// So one spanning many reads still arrives as a single packet.
...
// Many messages inside one read stay separate, and stay in order.
...
// Both directions at once, which is what a lockstep session does.
