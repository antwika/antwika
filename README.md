...
That picture is hand-curated art, committed as it is, and `antwika/game/TileAtlas.hpp` is the address map that says which slot holds what -- see [`docs/game-texture-atlas.md`](docs/game-texture-atlas.md) before editing it.
