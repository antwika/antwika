...
`assets/atlas.png` used to be generated by a script CI re-ran to prove it had not drifted; the art is now drawn and curated directly, so nothing rebuilds it and editing it is editing the art — see [`docs/game-texture-atlas.md`](../../docs/game-texture-atlas.md).
...
- [`docs/game-texture-atlas.md`](../../docs/game-texture-atlas.md) — what an artist has to produce.
