...
| [io](libraries/io.md) | Opening, writing and flushing files, stated once and thrown as the caller's own type. |
...
| [sudoku](apps/sudoku.md) | A Sudoku played with a mouse and a keyboard, finished by a solver that never guesses. |
