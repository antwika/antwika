...
namespace
{
    ...
    protected:
        ...
        // Declared after the codec, which it keeps a reference to.
...
// A drag's distance is what the fold would otherwise have swallowed.
...
// The pointer stays where it was; only the tick's edges go.
