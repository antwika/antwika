...
TEST(EndpointTest, OperatorEquals_ComparesEveryFieldIndependently)
{
...
TEST(EndpointTest, OperatorCompare_ComparesTheHostBeforeThePort)
{
...
TEST(EndpointTest, OperatorCompare_FallsBackToThePortOnOneHost)
{
...
TEST(EndpointTest, OperatorCompare_ReportsEqualEndpointsEquivalent)
{
    const Endpoint endpoint{.host = "localhost", .port = Port{9000}};
...
TEST(EndpointTest, OperatorCompare_MakesAnEndpointAnOrderedMapKey)
{
