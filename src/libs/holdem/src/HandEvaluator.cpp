...
namespace antwika::holdem
{
    ...
    namespace
    {
        ...
        // Slots fill most-significant first.
        // An unused slot ends up a trailing zero, which is exactly right.
        // It means poker looks no further, and every such hand agrees.
        ...
        {
            // Bit 0 of the extended mask is the ace playing low.
            // That finds the 5-4-3-2-A wheel with no special case.
            ...
            // A set bit is a run's lowest card, one place above Rank.
            // The best run's top card is +4 there, so +3 back in Rank.
    ...
    HandValue evaluate(std::span<const Card> cards)
    {
        ...
        // Rank counting needs no counters, just ands and ors.
        // A rank held by n suits is in the union of the n-way ands.
        ...
        // Only one suit can hold five of seven cards.
        // So the last match found is the only match.
