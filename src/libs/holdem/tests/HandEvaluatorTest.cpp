...
{
    EXPECT_EQ(categoryOfHand("Ac Kd 9h 6s 5c"), HandCategory::HighCard);
...
{
    EXPECT_EQ(
        categoryOfHand("9c 9d 9h 4s 4c 4d 2s"), HandCategory::FullHouse);
    EXPECT_EQ(
...
{
    EXPECT_EQ(
        categoryOfHand("Ac Ad Kh Ks Qc Qd 2s"), HandCategory::TwoPair);
    EXPECT_EQ(
...
{
    EXPECT_EQ(categoryOfHand("Ac Kd Qh Js Tc 2d"), HandCategory::Straight);
