...
namespace antwika::gfx
{
    ...
    Bitmap PngReader::read(std::istream &in) const
    {
        ...
        // stb measures its input length in a signed int.
        // A longer stream than that wraps to some other length.
        // The decode then fails, which is already an error here.
        ...
        // Complete by construction, so isComplete() cannot be false.
        // stb succeeds only having written every pixel it reports.
