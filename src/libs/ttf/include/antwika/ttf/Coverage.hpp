...
namespace antwika::ttf
{
     ...
     *
     * **This is antwika::ttf's own value type rather than
     ...
     * Reusing gfx::Bitmap would also make antwika::ttf depend on
     ...
     * that wants a texture, and doc/ttf.md writes them out.
     *
    ...
    struct Coverage
    {
         ...
         * @throws TtfError If the position lies outside the mask.
         */
