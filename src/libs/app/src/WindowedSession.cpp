...
namespace antwika::app
{
    ...
    namespace
    {
        ...
        // The backend that draws nothing, and reports no close either.
            ...
            const WindowedSessionDesc &desc)
        {
            ...
            // Built field by field rather than as one aggregate.
            // A braced one holding a string trips the branch gate.
            // Its unwind cleanup lands on a line nothing can reach.
            WindowDesc window;
            ...
            const WindowPointerMapping &mapping)
        {
            ...
            // The one field describing the run rather than the app.
            // A replay already holds the input it recorded.
            // Reading a device too makes every event arrive twice.
