...
namespace antwika::tween
{
    ...
    namespace
    {
        ...
        // animation::interpolate multiplies a span by the eased
        // numerator in int64; a product that fits a Tick and not an
        // int64 would pass here and be garbage or UB there instead.
