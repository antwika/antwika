...
// An object with nothing required is still an object.
// Which is what a shape whose every member is optional says.
...
// No dialect and no title, deliberately.
// Only the outermost shape of a document states either.
...
// Built once and shared from then on, which is the whole point of it.
