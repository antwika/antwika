...
namespace antwika::replay
{
    ...
    namespace
    {
        ...
        // Both integer sorts have to be asked about separately.
        // nlohmann stores one signed or unsigned by how it was written.
        // So "7" and "7u" are not the same node kind.
