...
// Three levels deep.
// The order proves each parent is drawn before what is inside it.
...
// A container nobody sized takes its content plus its own padding.
...
// The fitting one takes its content and the growing one takes the rest.
