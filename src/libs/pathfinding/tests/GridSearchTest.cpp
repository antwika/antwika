...
TEST(GridSearchTest, FindPath_ReportsTheStartAloneWhenItIsAlreadyTheGoal)
{
    const GridGraph grid = gridWithWallsAt(3, 3, {});
...
TEST(GridSearchTest, FindPath_BreaksAnEqualLengthTieTowardsTheEarlierCell)
{
    ...
    // Both corners give a two-step route.
    // Node 1 is right of the start and node 2 below, so node 1 wins.
