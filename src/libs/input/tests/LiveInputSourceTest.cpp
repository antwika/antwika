...
// The inner source goes first.
// So ordering within a tick does not depend on how fast a device was polled.
...
// A queue nobody empties is a device that eventually stops being heard.
