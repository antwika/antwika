...
TEST(KeyModifiersTest, DefaultConstruction_HoldsNothing)
{
...
TEST(KeyModifiersTest, Equality_IsTrueForTheSameModifiers)
{
...
TEST(KeyModifiersTest, Equality_IsFalseWhenShiftDiffers)
{
...
TEST(KeyModifiersTest, Equality_IsFalseWhenControlDiffers)
{
    constexpr KeyModifiers other{
...
TEST(KeyModifiersTest, Equality_IsFalseWhenAltDiffers)
{
    constexpr KeyModifiers other{
...
TEST(KeyModifiersTest, Equality_IsFalseWhenSuperDiffers)
{
    constexpr KeyModifiers other{
