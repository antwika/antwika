...
namespace antwika::simulation
{
     ...
     *
     * It lives beside EngineLoop because pacing is a property of the
     * loop rather than of any one application: two apps had a
     * byte-identical copy of this class and a third paced inside its
     * render sink.
     * antwika::time was the other candidate and cannot be, since ISystem
     * lives in antwika::ecs and antwika::ecs already depends on
     * antwika::time.
     *
