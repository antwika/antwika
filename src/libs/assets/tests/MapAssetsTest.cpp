...
using antwika::assets::getFallbackTiles;
using antwika::assets::faceTilesFor;
using antwika::gfx::GfxError;
using antwika::tilemap::kWallTileSize;
using antwika::assets::getLoadAtlas;
using antwika::assets::getLoadAtlasOrBlank;
using antwika::assets::getLoadCharacterSheet;
using antwika::map::Map;
using antwika::assets::getReadSharedOrBundled;
...
using antwika::assets::writeSharedTexture;

namespace
{

    constexpr std::string_view kAppName = "antwika_assets_tests";
...
{
    ASSERT_EQ(antwika::assets::kAtlasSheets.size(), 2U);

    EXPECT_EQ(
        antwika::assets::kAtlasSheets[0].name, "atlas-15x9.png");
    EXPECT_EQ(
        antwika::assets::kAtlasSheets[0].tileSize,
        antwika::tilemap::kWallTileSize);
    EXPECT_EQ(
        antwika::assets::kAtlasSheets[1].name, "atlas-15x12.png");
    EXPECT_EQ(
        antwika::assets::kAtlasSheets[1].tileSize,
