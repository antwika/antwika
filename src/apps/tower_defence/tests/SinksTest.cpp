...
namespace
{
    ...
    TEST(CampaignSinkTest, Handle_StepsTheCampaignOnlyOnATick)
    {
    ...
    TEST(ScoreSinkTest, Handle_DescribesTheBarOnlyOnATick)
    {
        Campaign campaign(tinyCampaign());
    ...
    TEST(TowerPlacementSinkTest, Handle_BuildsOnALeftPressOnOpenGround)
    {
        Campaign campaign(tinyCampaign());
        const InputEventCodec codec;
    ...
    TEST(TowerPlacementSinkTest, Handle_BuildsNothingOnTheRun)
    {
        Campaign campaign(tinyCampaign());
        const InputEventCodec codec;
        TowerPlacementSink sink(campaign, codec, kCanvas);
    ...
    TEST(TowerPlacementSinkTest, Handle_BuildsNothingOnTheScoreBar)
    {
        Campaign campaign(tinyCampaign());
        const InputEventCodec codec;
        TowerPlacementSink sink(campaign, codec, kCanvas);
    ...
    TEST(TowerPlacementSinkTest, Handle_BuildsOnlyOnALeftPress)
    {
        Campaign campaign(tinyCampaign());
        const InputEventCodec codec;
        TowerPlacementSink sink(campaign, codec, kCanvas);
    ...
    TEST(TowerPlacementSinkTest, Handle_BuildsNothingWithNoRoom)
    {
        Campaign campaign(tinyCampaign());
        const InputEventCodec codec;
    ...
    TEST(RenderSinkTest, Handle_DrawsAndPacesAFrameOnATick)
    {
        Campaign campaign(tinyCampaign());
        ScoreOverlay overlay(kCanvas);
