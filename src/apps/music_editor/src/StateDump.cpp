...
namespace antwika::music_editor
{
    ...
    namespace
    {
        ...
        constexpr antwika::enums::NameTable<KeyLayout> kLayouts{
            {"swedish", "english"}};

        constexpr antwika::enums::NameTable<Modal> kModals{
            {"none", "save", "load"}};

        constexpr antwika::enums::NameTable<ui::DragHome> kDrags{
            {"none", "text", "track"}};
            ...
            const nlohmann::json &encoded)
        {
            ...
            editor.layout = antwika::enums::fromName<StateDumpError>(
                kLayouts,
                encoded.at("layout").get<std::string>(),
                "antwika::music_editor: dump names a keyboard this "
                "build does not know: ");
            editor.layoutOpen =
                encoded.at("layoutOpen").get<bool>();

            editor.dragging = antwika::enums::fromName<StateDumpError>(
                kDrags,
                encoded.at("dragging").get<std::string>(),
                "antwika::music_editor: dump names a drag home this "
                "build does not know: ");
            ...
            editor.modal = antwika::enums::fromName<StateDumpError>(
                kModals,
                encoded.at("modal").get<std::string>(),
                "antwika::music_editor: dump names a modal this build "
                "does not know: ");
            editor.fileName =
