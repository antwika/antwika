...
TEST(EditorStateTest, OpeningState_OpensWithSomethingAlreadyPlaying)
{
...
TEST(EditorStateTest, WidgetIds_AreDistinctAndNamed)
{
...
TEST(EditorStateTest, ApplyEdit_WritesAndMovesTheCaret)
{
    EditorState state;
...
TEST(EditorStateTest, ApplyEdit_IgnoresAnotherWidget)
{
...
TEST(EditorStateTest, OpeningState_ComparesFieldByField)
{
    const auto state = openingState();

    const auto twin = state;
    EXPECT_EQ(state, twin);
...
TEST(EditorStateTest, AddScore_AddsAScoreInOrderAndOnlyOnce)
{
    auto state = openingState();
...
TEST(EditorStateTest, OpeningState_OpensSwedishWithNoSelection)
{
    const auto state = openingState();
...
TEST(EditorStateTest, ApplyEdit_CarriesTheSelectionAndCopy)
{
    EditorState state;
...
TEST(EditorStateTest, ApplyScroll_AScrollReportMovesThePane)
{
    EditorState state;
...
TEST(EditorStateTest, ApplyScroll_IgnoresAnotherWidget)
{
    auto state = openingState();
    const auto before = state;
