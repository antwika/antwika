...
namespace antwika::companion
{
    ...
    namespace
    {
        ...
        // One verb per prop, in Prop's own order.
        // A table rather than a switch, and so no branch at all.
        // A fourth prop is a box in PetLayout and one entry here.
    ...
    void PropSink::handle(const TickEvent &event)
    {
        ...
        // A press on nothing in particular is a prod rather than a miss.
