...
namespace antwika::companion
{
     ...
     *
     * The document names the metabolism -- periods, gauges and
     * what each verb moves them by.
     * The three energy numbers stay in source: the save format
     * derives its perished marker from them, and a bound a
     * persisted file depends on may not drift with an editable
     * one.
     *
