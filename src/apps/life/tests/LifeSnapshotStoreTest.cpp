...
TEST(LifeSnapshotStoreTest, Dump_CarriesTheBoardDragAndConsole)
{
...
TEST(LifeSnapshotStoreTest, Load_ComesBackToTheDumpedInstant)
{
    const antwika::testing::ScratchFile file(
...
TEST(LifeSnapshotStoreTest, Load_EndsADragTheDumpDidNotHold)
{
    const antwika::testing::ScratchFile file(
...
TEST(LifeSnapshotStoreTest, Load_RefusesABoardOfAnotherSize)
{
    const antwika::testing::ScratchFile file(
...
TEST(LifeSnapshotStoreTest, Load_RefusesAStateThisBuildCannotRead)
{
    const antwika::testing::ScratchFile file(
...
TEST(LifeSnapshotStoreTest, Dump_CarriesNoDragWithoutAPointerSink)
{
    const antwika::testing::ScratchFile file(
...
TEST(LifeSnapshotStoreTest, Load_RefusesABoardOfAnotherHeight)
{
    const antwika::testing::ScratchFile file(
