...
namespace
{
    ...
    struct LifeConsoleTraits final
    {
...
namespace antwika::console::conformance
{
    ...
    INSTANTIATE_TYPED_TEST_SUITE_P(
        Life, ConsoleContractTest, LifeConsoleTraits);

    INSTANTIATE_TYPED_TEST_SUITE_P(
        Life, ConsoleSnapshotRoundTripTest, LifeConsoleTraits);

}

TEST(ConsoleSinkTest, Run_TogglesNoCellUnderTheSheet)
{
    ConsoleHarness harness;
...
TEST(ConsoleSinkTest, LoadState_ComesBackToTheDumpedBoard)
{
    const antwika::testing::ScratchFile file(
