...
TEST(LifeSystemTest, A2x2BlockIsAStableStillLife)
{
...
TEST(LifeSystemTest, ASingleLiveCellWithNoNeighborsDies)
{
    NiceMock<MockLogger> logger;
    World world(logger);
    Grid grid(world, 3, 3);
...
TEST(LifeSystemTest, ADeadCellWithExactlyThreeNeighborsBecomesAlive)
{
    NiceMock<MockLogger> logger;
    World world(logger);
    Grid grid(world, 3, 3);
