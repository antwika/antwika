...
// Cells stay square whichever way the canvas is out of proportion.
...
// A canvas that does not divide evenly leaves a margin on both sides.
// The offsets are what would underflow if cells were rounded up.
...
// Nothing is drawn rather than drawing zero-sized or wrapped rectangles.
