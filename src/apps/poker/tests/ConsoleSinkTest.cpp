...
namespace
{
    ...
    struct PokerConsoleTraits final
    {
...
namespace antwika::console::conformance
{
    ...
    INSTANTIATE_TYPED_TEST_SUITE_P(
        Poker, ConsoleContractTest, PokerConsoleTraits);

}

TEST(ConsoleSinkTest, DumpState_WritesTheRoomMidHand)
{
...
TEST(ConsoleSinkTest, Play_IgnoresKeysWithNoConsoleMounted)
{
    std::chrono::system_clock::time_point time{};
    FakeClock clock(time);
    NiceMock<MockLogger> logger;
