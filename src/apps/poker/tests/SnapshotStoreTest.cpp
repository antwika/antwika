...
TEST(SnapshotStoreTest, Load_ContinuesTheSessionExactly)
{
...
TEST(SnapshotStoreTest, Load_RefusesAnotherTablesCounts)
{
    const antwika::testing::ScratchFile file(
...
TEST(SnapshotStoreTest, Load_RefusesAnotherTablesNoteCount)
{
    const antwika::testing::ScratchFile file(
...
TEST(SnapshotStoreTest, Load_WrapsWhatTheTableRefuses)
{
    const antwika::testing::ScratchFile file(
...
TEST(SnapshotStoreTest, Load_RefusesAFileThatIsNotThere)
{
    const antwika::testing::ScratchFile file(
