...
// The seam's whole shape: absent means what the game had before.
// A consumer written against this needs no case for a fresh house.
...
// Including a handle whose entity was never anything at all.
...
// add() where there was none, set() where there was one.
// Asking once here is what keeps every writer from asking.
