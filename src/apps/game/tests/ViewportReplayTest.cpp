...
TEST(ViewportReplayTest, Replay_RepeatsOnAWindowOfAnotherSize)
{
...
TEST(ViewportReplayTest, Record_IsTheSameGameAnyWindow)
{
...
TEST(ViewportReplayTest, Record_ScalesThePictureWithTheWindow)
{
