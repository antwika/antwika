...
TEST(StateDumpTest, OperatorEquals_EqualityComparesEveryField)
{
...
TEST(StateDumpTest, FromJson_ReadsVersionOneThroughEnvelope)
{
    const auto dump = populatedDump();
...
TEST(StateDumpTest, FromJson_AllowsVersionOneToLackItsTool)
{
