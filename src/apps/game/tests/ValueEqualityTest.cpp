...
namespace
{
    ...
    TEST(BuildGhostTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(SceneSnapshotTest, OperatorEquals_ComparesEveryBuildingViewField)
    {
    ...
    TEST(SceneSnapshotTest, OperatorEquals_ComparesEveryBuildingSpriteField)
    {
    ...
    TEST(SceneSnapshotTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(GameSummaryTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(CityRatingsValueTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(StaffComponentTest, OperatorEquals_ComparesTheLedger)
    {
        Staff base;
    ...
    TEST(StoredStaffTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(StoredEmploymentTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(EmploymentComponentTest, OperatorEquals_ComparesTheLedger)
    {
        Employment base;
    ...
    TEST(StaffingTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(SaveGameTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(WorldMapTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(WorldMapSceneTest, OperatorEquals_ComparesEverySnapshotField)
    {
    ...
    TEST(BuildingTest, OperatorEquals_ComparesEveryField)
    {
        const Building base{
            .kind = BuildingKind::Farm,
            .stock = {1, 2, 3},
        ...
        expectMemberCompared(
            base,
            [](Building &b) { b.selling = Resource::Pottery; });
        expectMemberCompared(
            base,
            [](Building &b)
    ...
    TEST(ErrandComponentTest, OperatorEquals_ComparesEveryField)
    {
        const Errand base{
    ...
    TEST(ProductionComponentTest, OperatorEquals_ComparesItsCountdown)
    {
    ...
    TEST(HousingRequirementTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(HouseholdComponentTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST(GameConfigValueTest, OperatorEquals_ComparesEveryField)
    {
        ...
        expectMemberCompared(
            base, [](GameConfig &t) { t.spreadDelayTicks = 99; });
        expectMemberCompared(
            base, [](GameConfig &t) { t.migrantPeriodTicks = 99; });
        expectMemberCompared(
    ...
    TEST(ValueEqualityTest, OperatorEquals_ComparesEveryPlayerOptionsMember)
    {
