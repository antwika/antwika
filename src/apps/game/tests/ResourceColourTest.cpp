...
TEST(ResourceColourTest, ResourceColour_IsUniquePerResource)
{
...
TEST(ResourceColourTest, ServiceColour_IsUniquePerService)
{
    std::set<std::uint32_t> seen;
...
TEST(ResourceColourTest, ResourceColour_DiffersFromEveryService)
{
    std::set<std::uint32_t> seen;
