...
namespace
{
    ...
    TEST_F(SaveLoadSinkTest, Handle_DescribesTheScreenEveryTick)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_DoesNothingOutsideSaveLoad)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_AnEventThatIsNotInputIsIgnored)
    {
        dispatch(
            TickEvent{
                .tick = 0,
    ...
    TEST_F(SaveLoadSinkTest, Handle_BackGoesToTheMainMenu)
    {
        press(saveWidgets::kBack);
    ...
    TEST_F(SaveLoadSinkTest, Handle_KeepsWhatIsTypedIntoTheField)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_ReachesTheFieldWithTab)
    {
        type(Key::Tab);
        type(Key::Tab);
        type(Key::T);
    ...
    TEST_F(SaveLoadSinkTest, Handle_BackspacesBeforeTheCaret)
    {
        press(saveWidgets::kName);
        type(Key::A);
        type(Key::B);
    ...
    TEST_F(SaveLoadSinkTest, Handle_SavesUnderTheTypedName)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_EnterInTheFieldSavesToo)
    {
        press(saveWidgets::kName);
        type(Key::T);
        type(Key::Enter);
    ...
    TEST_F(SaveLoadSinkTest, Handle_SaysSoWhenNoNameIsGiven)
    {
        press(saveWidgets::kSave);
    ...
    TEST_F(SaveLoadSinkTest, Handle_SavesTheSelectedNameWhenBlank)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_SaysSoWhenASaveCannotBeWritten)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_SaysSoWhenNothingIsSelected)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_RestoresAndOpensTheGridOnLoad)
    {
    ...
    TEST_F(SaveLoadSinkTest, Handle_SaysSoWhenALoadCannotBeRead)
    {
        state.add("missing");
    ...
    TEST_F(SaveLoadSinkTest, Handle_OpensAndClosesThePicker)
    {
        writeSave("town", Cell{.x = 1, .y = 1});
        state.add("town");
    ...
    TEST_F(SaveLoadSinkTest, Handle_SelectsAnOptionAndShutsTheList)
    {
        state.add("alpha");
        state.add("beta");
    ...
    TEST_F(SaveLoadSinkTest, Handle_ShowsWhatThePressChanged)
    {
        state.add("town");
    ...
    TEST_F(SaveLoadSinkTest, Handle_AMiddlePressActivatesNothing)
    {
