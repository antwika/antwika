...
namespace
{
    ...
    TEST_F(CityGridTest, RestoreCityGrid_PutsBackWhatWasTaken)
    {
        ...
        ASSERT_EQ(taken.buildings.size(), 1U);
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesEveryStoredWalkerField)
    {
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesEveryStoredBuildingField)
    {
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesEveryField)
    {
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesAStoredWalkersJourney)
    {
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesAStoredWalkersErrand)
    {
        StoredWalker base{.at = Cell{1, 1}, .walker = Walker{}};
        base.errand = Errand{};
        base.destination = 2U;
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesAStoredBuildingsCountdown)
    {
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesAStoredBuildingsHousehold)
    {
        StoredBuilding base{.at = Cell{1, 1}, .building = Building{}};
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesAStoredBuildingsLedgers)
    {
        StoredBuilding base{.at = Cell{1, 1}, .building = Building{}};
    ...
    TEST_F(CityGridTest, OperatorEquals_ComparesEveryStoredRuinField)
    {
