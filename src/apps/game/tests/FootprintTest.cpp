...
TEST(FootprintTest, Ctor_AFreshFootprintIsOneCell)
{
...
TEST(FootprintTest, FootprintOf_IsSquareForEveryKind)
{
...
TEST(FootprintTest, Ctor_EqualityComparesBothExtents)
{
...
TEST(FootprintTest, FootprintOf_EveryKindIsTheSizeTheAtlasContractSays)
{
