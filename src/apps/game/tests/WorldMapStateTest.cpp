...
namespace
{
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_StartsWithTheFirstCityOpen)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_OpeningACitySwapsItsGridIn)
    {
    ...
    TEST_F(WorldMapStateTest, CloseCity_KeepsTheGridWithItsCity)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_ShowsWhatWasBuiltBefore)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_KeepsBuildingsToOneCity)
    {
        layPath(Cell{2, 2});
    ...
    TEST_F(WorldMapStateTest, CloseCity_KeepsWhatIsOnlyStaged)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_KeepsABuildingsWalkerOut)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_KeepsEachCitysOwnGrid)
    {
    ...
    TEST_F(WorldMapStateTest, OpenCityAt_RefusesANonexistentCity)
    {
        const WorldMapState &readOnly = state;
