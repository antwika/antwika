...
TEST(DirectionTest, DirectionCountMatchesTheEnumeration)
{
...
TEST(DirectionTest, FourRightTurnsComeBackToWhereTheyStarted)
{
...
TEST(DirectionTest, TurningWrapsADirectionOutsideTheEnumerationRound)
{
    // Total rather than undefined.
    // That is what lets these be arithmetic with no default case.
