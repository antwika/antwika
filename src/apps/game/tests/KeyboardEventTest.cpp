...
TEST(KeyboardEventTest, KeyboardFromPayload_RoundTripsEveryLayout)
{
...
TEST(KeyboardEventTest, LocaleFromPayload_RefusesTheWrongShape)
{
    EXPECT_THROW(
...
TEST(KeyboardEventTest, KeyboardFromPayload_RefusesAnUnknownLayout)
{
    EXPECT_THROW(
