...
namespace antwika::task_worker
{
    ...
    namespace
    {
        ...
        // Two pixels a glyph pixel is the whole of the scaling here.
        // Every measurement below is a multiple of a glyph cell.
        // So the picture is one arithmetic rule.
        // A table of pixel counts would be a second one to keep in step.
        ...
        // Three fifths of the room for the pool and two for the queue.
        // A worker card carries a bar and two lines of text.
        // A queue entry carries one line.
        ...
        // How much of a worker's bar is filled, in whole pixels.
        // Nothing at all for a task with no duration on record.
        // Nothing either for one whose countdown has not moved yet.
        // A task claimed this tick has done none of its work.
        ...
        // A queue longer than the panel runs off the bottom of it.
        // There is no clipping in antwika::gfx to cut it short with.
        // A queue that stopped listing itself would hide the point.
        void drawQueue(
            IRenderer &renderer,
            const Translator &translator,
            const Columns &columns,
        ...
        const PoolSnapshot &snapshot) const
    {
        ...
        // A canvas with no room for the two columns is left cleared.
        // Drawn anyway, its panels would overlap one another.
        // And its text would sit outside the panels it belongs to.
