...
namespace antwika::task_worker
{
    ...
    namespace
    {
        ...
        // A task nothing waits on is ready the moment it is submitted.
        // One waiting on a task nothing submitted stays blocked.
        // The scheduler has no completed dependency to unblock it with.
        ...
        {
            // Excluded for the cleanup edge the strings here carry.
            // It is reachable only if one of them fails to allocate.
        ...
        antwika::time::Tick tick)
    {
        ...
        // Blocked entries are appended after the sort, not sorted in.
        // A blocked task is not in line for a worker at all.
        // One at the head would say the next free worker takes it.
        ...
        // That order is ascending JobId, the scheduler's own tie-break.
        std::stable_sort(
