...
TEST(StatusPrintSystemTest, PrintsEmptySectionsWhenNothingExistsYet)
{
...
TEST(StatusPrintSystemTest, PrintsEveryTaskInSubmissionOrderRegardlessOfStatus)
{
    NiceMock<MockLogger> logger;
    World world(logger);
...
TEST(StatusPrintSystemTest, PrintsARunningTaskWithItsLiveCountdown)
{
    NiceMock<MockLogger> logger;
    World world(logger);
...
TEST(StatusPrintSystemTest, PrintsEveryWorkersCurrentState)
{
    NiceMock<MockLogger> logger;
    World world(logger);
