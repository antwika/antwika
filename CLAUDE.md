...
- `apps/game` is an isometric grid you build on with the mouse: left-click lays a path tile, left-drag lays a whole run of them, right-click drops a walker onto one, middle-drag pans and the wheel zooms.
