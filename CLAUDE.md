...
An app attaching the gate cannot draw anything that follows a free-moving pointer, since the movements between clicks are deliberately not in the tick stream -- see [`docs/replay-size-plan.md`](docs/replay-size-plan.md).
